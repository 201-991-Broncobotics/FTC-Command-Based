...
public class Mecanum_Old extends SubsystemBase { // uses the control hub's IMU to keep a constant heading
    ...
    protected final double strafe = 0.95, // ratio of strafe speed vs forward speed; should be less than one
        calibration_time = 1,
    ...
    public static final boolean brake = true, invert_imu = true;

    public static final boolean[] invert_drive_motors = new boolean[] {
            false, false, true, false
    };

    /** x and y in inches, angle in degrees clockwise; ordered by right front, right back, left back, left front */
    public Mecanum_Old(HardwareMap map, Telemetry telemetry, String[] wheel_names, double starting_x,
                       double starting_y, double starting_angle,
