...
import org.firstinspires.ftc.teamcode.subsystems.subsubsystems.CSensor;

@Autonomous(name = "23737 Auton - Test (Red Side)")
public class RedOLD extends CommandOpMode {
    @Override
    public void initialize() {
        ...
        //insert Subsystems
        CSensor CSensor = new CSensor(hardwareMap); //Puts in color sensor
